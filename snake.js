...
// Получаем ширину и высоту элумента canvas
...
Snake. prototype.draw = function () {
  for (let i = 0; i < this.segments.length; i++) {
    this.segments[i].drawSqure("Blue");
  }
};
...
// Проверяем, не столкнулась ли змейка со стенкой или собственным телом
...
// Задаем конструктор Эппл (яблоко)
let Apple = function () {
...
// Запускаем функцию анимации через сетИнтервал
...
// Задаем обработчик события Кейдаун (клавиши-стрелки)
